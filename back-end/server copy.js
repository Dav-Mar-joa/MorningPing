...
//   // Ici, tu peux enregistrer dans la DB, valider, etc.
//   console.log('Reçu:', event, date);
...
// Exemple simplifié, ici tu dois récupérer userId de la session/authentification
...
//   });
  ...
  //       // const localDate = new Date().toLocaleString("sv-SE", { timeZone: timezone }); 
